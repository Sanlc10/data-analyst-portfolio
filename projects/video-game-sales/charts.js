...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (ctxR) {
    ...
    const releases = [
      ...
      939, 1006, 1198, 1428, 1430,    // 2005–2009
  ...
  if (ctxS) {
    /* Simulated scatter — pattern matches notebook output: near-flat trend.
       Each point ~ (user_score 1–10, total_sales 0–8M). */
    const points = [];
    const rng = (s) => {
      let x = s;
    ...
    new Chart(ctxS, {
      ...
      data: {
        datasets: [{
          ...
          /* Trend line — drawn as a near-horizontal line to reflect r ≈ 0.03 */
          label: 'Trend (r ≈ 0.03)',
          type: 'line',
